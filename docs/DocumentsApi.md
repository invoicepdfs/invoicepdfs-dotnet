...
{
    Debug.Print("Exception when calling DocumentsApi.DownloadDocumentXmlWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class RenderDocumentXmlExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling DocumentsApi.RenderDocumentXml: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling DocumentsApi.RenderDocumentXmlWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
