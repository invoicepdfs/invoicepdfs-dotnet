...
namespace InvoicePDFs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DocumentCreateRequest")]
    public partial class DocumentCreateRequest : IValidatableObject
    {
        /// <summary>
        ...
        public DocumentCreateRequest(DocumentTypeEnum? documentType = DocumentTypeEnum.Invoice, string number = default(string), DateOnly issueDate = default(DateOnly), DateOnly dueDate = default(DateOnly), string currency = default(string), string locale = default(string), string businessProfileId = default(string), string customerId = default(string), string sourceDocumentId = default(string), string reason = default(string), PostalAddress shipTo = default(PostalAddress), string buyerReference = default(string), string taxScheme = default(string), DateOnly deliveryDate = default(DateOnly), List<StandardLineItemInput> lineItems = default(List<StandardLineItemInput>), List<LineItemDiscountInput> discounts = default(List<LineItemDiscountInput>), InvoiceShippingInput shipping = default(InvoiceShippingInput), List<InvoiceNoteInput> notes = default(List<InvoiceNoteInput>), List<InvoiceTermInput> terms = default(List<InvoiceTermInput>), List<InvoiceCustomFieldInput> customFields = default(List<InvoiceCustomFieldInput>), InvoicePaymentInput payment = default(InvoicePaymentInput), InvoiceBrandingInput branding = default(InvoiceBrandingInput), string brandingProfileId = default(string))
        {
            // to ensure "number" is required (not null)
            if (number == null)
            {
                throw new ArgumentNullException("number is a required property for DocumentCreateRequest and cannot be null");
            }
            this.Number = number;
            // to ensure "issueDate" is required (not null)
            if (issueDate == null)
            {
                throw new ArgumentNullException("issueDate is a required property for DocumentCreateRequest and cannot be null");
            }
            this.IssueDate = issueDate;
            // to ensure "currency" is required (not null)
            if (currency == null)
            {
                throw new ArgumentNullException("currency is a required property for DocumentCreateRequest and cannot be null");
            }
            this.Currency = currency;
            // to ensure "businessProfileId" is required (not null)
            if (businessProfileId == null)
            {
                throw new ArgumentNullException("businessProfileId is a required property for DocumentCreateRequest and cannot be null");
            }
            this.BusinessProfileId = businessProfileId;
            // to ensure "customerId" is required (not null)
            if (customerId == null)
            {
                throw new ArgumentNullException("customerId is a required property for DocumentCreateRequest and cannot be null");
            }
            this.CustomerId = customerId;
            // to ensure "lineItems" is required (not null)
            if (lineItems == null)
            {
                throw new ArgumentNullException("lineItems is a required property for DocumentCreateRequest and cannot be null");
            }
