...
namespace InvoicePDFs.Model
{
    ...
    /// InvoiceDraftRequest
    /// </summary>
    [DataContract(Name = "InvoiceDraftRequest")]
    public partial class InvoiceDraftRequest : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InvoiceDraftRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InvoiceDraftRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InvoiceDraftRequest" /> class.
        /// </summary>
        ...
        public InvoiceDraftRequest(string invoiceNumber = default(string), DocumentTypeEnum? documentType = DocumentTypeEnum.Invoice, DateOnly issueDate = default(DateOnly), DateOnly dueDate = default(DateOnly), string currency = default(string), string locale = default(string), string businessProfileId = default(string), string customerId = default(string), PostalAddress shipTo = default(PostalAddress), string buyerReference = default(string), string taxScheme = default(string), DateOnly deliveryDate = default(DateOnly), string precedingInvoiceNumber = default(string), List<InvoiceLineItemInput> lineItems = default(List<InvoiceLineItemInput>), List<InvoiceDiscountInput> discounts = default(List<InvoiceDiscountInput>), InvoiceShippingInput shipping = default(InvoiceShippingInput), List<InvoiceNoteInput> notes = default(List<InvoiceNoteInput>), List<InvoiceTermInput> terms = default(List<InvoiceTermInput>), List<InvoiceCustomFieldInput> customFields = default(List<InvoiceCustomFieldInput>), InvoicePaymentInput payment = default(InvoicePaymentInput), InvoiceBrandingInput branding = default(InvoiceBrandingInput))
        {
            // to ensure "invoiceNumber" is required (not null)
            if (invoiceNumber == null)
            {
                throw new ArgumentNullException("invoiceNumber is a required property for InvoiceDraftRequest and cannot be null");
            }
            this.InvoiceNumber = invoiceNumber;
            // to ensure "issueDate" is required (not null)
            if (issueDate == null)
            {
                throw new ArgumentNullException("issueDate is a required property for InvoiceDraftRequest and cannot be null");
            }
            this.IssueDate = issueDate;
            // to ensure "currency" is required (not null)
            if (currency == null)
            {
                throw new ArgumentNullException("currency is a required property for InvoiceDraftRequest and cannot be null");
            }
            this.Currency = currency;
            // to ensure "businessProfileId" is required (not null)
            if (businessProfileId == null)
            {
                throw new ArgumentNullException("businessProfileId is a required property for InvoiceDraftRequest and cannot be null");
            }
            this.BusinessProfileId = businessProfileId;
            // to ensure "customerId" is required (not null)
            if (customerId == null)
            {
                throw new ArgumentNullException("customerId is a required property for InvoiceDraftRequest and cannot be null");
            }
            this.CustomerId = customerId;
            // to ensure "lineItems" is required (not null)
            if (lineItems == null)
            {
                throw new ArgumentNullException("lineItems is a required property for InvoiceDraftRequest and cannot be null");
            }
