...
namespace InvoicePDFs.Test.Model
{
    ...
    public class InvoiceCreateRequestTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsType" InvoiceCreateRequest
            //Assert.IsType<InvoiceCreateRequest>(instance);
        }
